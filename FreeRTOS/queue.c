...
BaseType_t xQueueAltGenericReceive(QueueHandle_t xQueue, void* const pvBuffer,
...
BaseType_t xQueueGenericSendFromISR(QueueHandle_t xQueue,
                                    const void* const pvItemToQueue, BaseType_t* const pxHigherPriorityTaskWoken,
                                    const BaseType_t xCopyPosition)
{
    BaseType_t xReturn;
...
QueueSetHandle_t xQueueCreateSet(const UBaseType_t uxEventQueueLength)
{
    ...
    pxQueue = xQueueGenericCreate(uxEventQueueLength, sizeof(Queue_t*),
                                  queueQUEUE_TYPE_SET);

...
PRIVILEGED_DATA static List_t
xDelayedTaskList1;                        /*< Delayed tasks. */
PRIVILEGED_DATA static List_t
...
PRIVILEGED_DATA static volatile UBaseType_t uxPendedTicks           =
    (UBaseType_t) 0U;
PRIVILEGED_DATA static volatile BaseType_t xYieldPending            = pdFALSE;
PRIVILEGED_DATA static volatile BaseType_t xNumOfOverflows          =
    (BaseType_t) 0;
PRIVILEGED_DATA static UBaseType_t uxTaskNumber                     =
    (UBaseType_t) 0U;
...
static UBaseType_t prvListTaskWithinSingleList(TaskStatus_t* pxTaskStatusArray,
...
BaseType_t xTaskGenericCreate(TaskFunction_t pxTaskCode,
                              const char* const pcName, const uint16_t usStackDepth, void* const pvParameters,
...
void vTaskStartScheduler(void)
{
...
#if ( INCLUDE_xTaskGetIdleTaskHandle == 1 )
    {
        ...
        xReturn = xTaskCreate(prvIdleTask, "IDLE", tskIDLE_STACK_SIZE, (void*) NULL,
...
static void prvInitialiseTCBVariables(TCB_t* const pxTCB,
                                      const char* const pcName, UBaseType_t uxPriority,
                                      const MemoryRegion_t* const xRegions,
                                      const uint16_t usStackDepth)  /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
{
    UBaseType_t x;
        ...
        List_t* pxList, eTaskState eState)
{
    ...
    if (listCURRENT_LIST_LENGTH(pxList) > (UBaseType_t) 0) {
        ...
        do {
            ...
            pxTaskStatusArray[ uxTask ].pcTaskName = (const char*) &

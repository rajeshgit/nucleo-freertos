                                   ...
                                   TaskFunction_t pxCode, void* pvParameters)
{
    ...
    *pxTopOfStack = (StackType_t)
                    pxOriginalTOS;   /* Stack used when task starts goes in R13. */
    pxTopOfStack--;
...
static void prvSetupTimerInterrupt(void)
{
    ...
    AT91C_BASE_AIC->AIC_SMR[ portTIMER_AIC_CHANNEL ] =
        AIC_SRCTYPE_INT_LEVEL_SENSITIVE | portTICK_PRIORITY_6;
    ...
    if ((configCPU_CLOCK_HZ / (configTICK_RATE_HZ * 2)) <= 0xFFFF) {
        ...
        clock (main clock / 2). */
        portTIMER_REG_BASE_PTR->TC_CMR = TC_WAVE | TC_CLKS_MCK2 | TC_BURST_NONE |
                                         TC_CPCTRG;
        ...
        portTIMER_REG_BASE_PTR->TC_CMR = TC_WAVE | TC_CLKS_MCK8 | TC_BURST_NONE |
                                         TC_CPCTRG;

                                   ...
                                   TaskFunction_t pxCode, void* pvParameters)
{
    ...
    *pxTopOfStack = (StackType_t)
                    &_SDA_BASE_;   /* address of the first small data area */
    pxTopOfStack -= 10;
    ...
    *pxTopOfStack = (StackType_t) pvParameters;
    ...
    /* Parameters in R2. */
    *pxTopOfStack = (StackType_t)
                    &_SDA2_BASE_;      /* address of the second small data area */
    pxTopOfStack--;
...
BaseType_t xPortStartScheduler(void)
{
    ...
    XExc_RegisterHandler(XEXC_ID_SYSTEM_CALL, (XExceptionHandler) vPortYield,
                         (void*) 0);
    vPortStartFirstTask();
...
static void prvSetupTimerInterrupt(void)
{
    ...
    XExc_RegisterHandler(XEXC_ID_DEC_INT, (XExceptionHandler) vPortTickISR,
                         (void*) 0);
...
void vPortISRHandler(void* pvNullDoNotUse)
{
    ...
    for (xInterruptNumber = 0; xInterruptNumber < XPAR_INTC_MAX_NUM_INTR_INPUTS;
         xInterruptNumber++) {
...
void vPortSetupInterruptController(void)
{
    ...
    XExc_RegisterHandler(XEXC_ID_NON_CRITICAL_INT,
                         (XExceptionHandler) vPortISRWrapper, NULL);
                                        ...
                                        XInterruptHandler pxHandler, void* pvCallBackRef)
{
    ...
    if (XST_SUCCESS == XIntc_Connect(&xInterruptController, ucInterruptID,
                                     pxHandler, pvCallBackRef)) {

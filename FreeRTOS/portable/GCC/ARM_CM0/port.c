...
__attribute__((weak)) void vPortSuppressTicksAndSleep(TickType_t
        xExpectedIdleTime)
{
    ...
    ulReloadValue = portNVIC_SYSTICK_CURRENT_VALUE + (ulTimerCountsForOneTick *
    ...
    if (eTaskConfirmSleepModeStatus() == eAbortSleep) {
        ...
        if ((ulSysTickCTRL & portNVIC_SYSTICK_COUNT_FLAG) != 0) {
            ...
            ulCalculatedLoadValue = (ulTimerCountsForOneTick - 1UL) -
                                    (ulReloadValue - portNVIC_SYSTICK_CURRENT_VALUE);
            ...
            ulCompletedSysTickDecrements = (xExpectedIdleTime * ulTimerCountsForOneTick) -
                                           portNVIC_SYSTICK_CURRENT_VALUE;
            ...
            period remains. */
            portNVIC_SYSTICK_LOAD = ((ulCompleteTickPeriods + 1) * ulTimerCountsForOneTick)
